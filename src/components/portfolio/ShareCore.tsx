...
interface ShareCoreProps {
  username: string;
  themeType?: ThemeType;
}

// QR + kopyalanabilir URL + sosyal paylaşım butonları — ShareModal ve
// yayın kutlama ekranı tarafından ortak kullanılır, mantık tek yerde.
export default function ShareCore({ username, themeType }: ShareCoreProps) {
